...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'agent.form.registration' => 'getAgent_Form_RegistrationService',
            ...
            'doctrine.dbal.gspmanager_connection' => 'getDoctrine_Dbal_GspmanagerConnectionService',
            'doctrine.dbal.logger' => 'getDoctrine_Dbal_LoggerService',
            'doctrine.dbal.logger.profiling.gspmanager' => 'getDoctrine_Dbal_Logger_Profiling_GspmanagerService',
            'doctrine.dbal.logger.profiling.tontine' => 'getDoctrine_Dbal_Logger_Profiling_TontineService',
            'doctrine.dbal.tontine_connection' => 'getDoctrine_Dbal_TontineConnectionService',
            'doctrine.orm.gspmanager_entity_listener_resolver' => 'getDoctrine_Orm_GspmanagerEntityListenerResolverService',
            'doctrine.orm.gspmanager_entity_manager' => 'getDoctrine_Orm_GspmanagerEntityManagerService',
            'doctrine.orm.gspmanager_entity_manager.property_info_extractor' => 'getDoctrine_Orm_GspmanagerEntityManager_PropertyInfoExtractorService',
            'doctrine.orm.gspmanager_listeners.attach_entity_listeners' => 'getDoctrine_Orm_GspmanagerListeners_AttachEntityListenersService',
            'doctrine.orm.gspmanager_manager_configurator' => 'getDoctrine_Orm_GspmanagerManagerConfiguratorService',
            ...
            'doctrine.orm.tontine_entity_listener_resolver' => 'getDoctrine_Orm_TontineEntityListenerResolverService',
            'doctrine.orm.tontine_entity_manager' => 'getDoctrine_Orm_TontineEntityManagerService',
            'doctrine.orm.tontine_entity_manager.property_info_extractor' => 'getDoctrine_Orm_TontineEntityManager_PropertyInfoExtractorService',
            'doctrine.orm.tontine_listeners.attach_entity_listeners' => 'getDoctrine_Orm_TontineListeners_AttachEntityListenersService',
            'doctrine.orm.tontine_manager_configurator' => 'getDoctrine_Orm_TontineManagerConfiguratorService',
            'doctrine.orm.validator.unique' => 'getDoctrine_Orm_Validator_UniqueService',
            'doctrine.orm.validator_initializer' => 'getDoctrine_Orm_ValidatorInitializerService',
            'doctrine_cache.providers.doctrine.orm.gspmanager_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_GspmanagerMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.gspmanager_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_GspmanagerQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.gspmanager_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_GspmanagerResultCacheService',
            'doctrine_cache.providers.doctrine.orm.tontine_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_TontineMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.tontine_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_TontineQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.tontine_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_TontineResultCacheService',
            ...
            'guzzle.client.api_gspmanager' => 'getGuzzle_Client_ApiGspmanagerService',
            'guzzle_bundle.formatter' => 'getGuzzleBundle_FormatterService',
            'guzzle_bundle.logger' => 'getGuzzleBundle_LoggerService',
            'guzzle_bundle.middleware.event_dispatch.api_gspmanager' => 'getGuzzleBundle_Middleware_EventDispatch_ApiGspmanagerService',
            'guzzle_bundle.middleware.log.api_gspmanager' => 'getGuzzleBundle_Middleware_Log_ApiGspmanagerService',
            'guzzle_bundle.middleware.request_header.api_gspmanager' => 'getGuzzleBundle_Middleware_RequestHeader_ApiGspmanagerService',
            'guzzle_bundle.middleware.wsse.api_gspmanager' => 'getGuzzleBundle_Middleware_Wsse_ApiGspmanagerService',
            ...
            'security.firewall.map.context.api_authentication' => 'getSecurity_Firewall_Map_Context_ApiAuthenticationService',
            ...
            'tontine.form.agent_group' => 'getTontine_Form_AgentGroupService',
            'tontine.gsp.entity_manager' => 'getTontine_Gsp_EntityManagerService',
            'tontine.journal' => 'getTontine_JournalService',
            'tontine.manager.bien' => 'getTontine_Manager_BienService',
            'tontine.manager.dashboard' => 'getTontine_Manager_DashboardService',
            'tontine.manager.group' => 'getTontine_Manager_GroupService',
            'tontine.menu_counters' => 'getTontine_MenuCountersService',
            'tontine.type.awesome_selector' => 'getTontine_Type_AwesomeSelectorService',
            ...
            'user_auth_token_provider' => 'getUserAuthTokenProviderService',
        ...
        $this->aliases = array(
            ...
            'database_connection' => 'doctrine.dbal.tontine_connection',
            'doctrine.orm.entity_manager' => 'doctrine.orm.tontine_entity_manager',
            'doctrine.orm.gspmanager_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.gspmanager_metadata_cache',
            'doctrine.orm.gspmanager_query_cache' => 'doctrine_cache.providers.doctrine.orm.gspmanager_query_cache',
            'doctrine.orm.gspmanager_result_cache' => 'doctrine_cache.providers.doctrine.orm.gspmanager_result_cache',
            'doctrine.orm.tontine_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.tontine_metadata_cache',
            'doctrine.orm.tontine_query_cache' => 'doctrine_cache.providers.doctrine.orm.tontine_query_cache',
            'doctrine.orm.tontine_result_cache' => 'doctrine_cache.providers.doctrine.orm.tontine_result_cache',
    ...
    /**
     * Gets the 'agent.form.registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tontineBundle\Form\AgentType A tontineBundle\Form\AgentType instance
     */
    protected function getAgent_Form_RegistrationService()
    {
        return $this->services['agent.form.registration'] = new \tontineBundle\Form\AgentType();
    }
    ...
    {
        return $this->services['ajaxify_search.controller'] = new \AjaxifySearch\AjaxifySearchController($this->get('doctrine.orm.tontine_entity_manager'), $this->get('templating'));
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'tontineBundle', ($this->targetDirs[3].'/app/Resources/tontineBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'tontineBundle', ($this->targetDirs[3].'/src/tontineBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'tontineApiBundle', ($this->targetDirs[3].'/app/Resources/tontineApiBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'tontineApiBundle', ($this->targetDirs[3].'/src/tontineApiBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GSPBundle', ($this->targetDirs[3].'/app/Resources/GSPBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GSPBundle', ($this->targetDirs[3].'/src/GSPBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GuzzleBundle', ($this->targetDirs[3].'/app/Resources/GuzzleBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GuzzleBundle', ($this->targetDirs[3].'/vendor/eightpoints/guzzle-bundle/EightPoints/Bundle/GuzzleBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Core23DompdfBundle', ($this->targetDirs[3].'/app/Resources/Core23DompdfBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Core23DompdfBundle', ($this->targetDirs[3].'/vendor/core23/dompdf-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('urrujEuaI1', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('InJC1xGFxj', 0, 'mgPeTphBASpksDNsvwYnqQ', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vm0jATTIfw', 0, 'mgPeTphBASpksDNsvwYnqQ', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OK9If19S9S', 0, 'mgPeTphBASpksDNsvwYnqQ', (__DIR__.'/pools'), $a));
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('tontine' => 'doctrine.dbal.tontine_connection', 'gspmanager' => 'doctrine.dbal.gspmanager_connection'), array('tontine' => 'doctrine.orm.tontine_entity_manager', 'gspmanager' => 'doctrine.orm.gspmanager_entity_manager'), 'tontine', 'tontine');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.gspmanager_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_GspmanagerConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.gspmanager'));
        ...
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.gspmanager_listeners.attach_entity_listeners'));
        $c->addEventListener(array(0 => 'postPersist', 1 => 'postRemove', 2 => 'postUpdate'), $this->get('tontine.journal'));

        return $this->services['doctrine.dbal.gspmanager_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'manager', 'user' => 'root', 'password' => 'mysqlconnect', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }

    /**
     * Gets the 'doctrine.dbal.tontine_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\DBAL\Connection A Doctrine\DBAL\Connection instance
     */
    protected function getDoctrine_Dbal_TontineConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.tontine'));
        ...
        $c = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this);
        $c->addEventSubscriber($this->get('fos_user.user_listener'));
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.tontine_listeners.attach_entity_listeners'));
        $c->addEventListener(array(0 => 'postPersist', 1 => 'postRemove', 2 => 'postUpdate'), $this->get('tontine.journal'));

        return $this->services['doctrine.dbal.tontine_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'design', 'user' => 'root', 'password' => 'mysqlconnect', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }

    /**
     * Gets the 'doctrine.orm.gspmanager_entity_listener_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_GspmanagerEntityListenerResolverService()
    {
        return $this->services['doctrine.orm.gspmanager_entity_listener_resolver'] = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerAwareEntityListenerResolver($this);
    }

    /**
     * Gets the 'doctrine.orm.gspmanager_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_GspmanagerEntityManagerService($lazyLoad = true)
    {
        $a = new \Doctrine\ORM\Configuration();
        $a->setEntityNamespaces(array());
        $a->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.gspmanager_metadata_cache'));
        $a->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.gspmanager_query_cache'));
        $a->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.gspmanager_result_cache'));
        ...
        $a->setNamingStrategy($this->get('doctrine.orm.naming_strategy.underscore'));
        $a->setQuoteStrategy($this->get('doctrine.orm.quote_strategy.default'));
        $a->setEntityListenerResolver($this->get('doctrine.orm.gspmanager_entity_listener_resolver'));

        $this->services['doctrine.orm.gspmanager_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.gspmanager_connection'), $a);

        $this->get('doctrine.orm.gspmanager_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.gspmanager_entity_manager.property_info_extractor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_GspmanagerEntityManager_PropertyInfoExtractorService()
    {
        return $this->services['doctrine.orm.gspmanager_entity_manager.property_info_extractor'] = new \Symfony\Bridge\Doctrine\PropertyInfo\DoctrineExtractor($this->get('doctrine.orm.gspmanager_entity_manager')->getMetadataFactory());
    }

    /**
     * Gets the 'doctrine.orm.gspmanager_listeners.attach_entity_listeners' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_GspmanagerListeners_AttachEntityListenersService()
    {
        return $this->services['doctrine.orm.gspmanager_listeners.attach_entity_listeners'] = new \Doctrine\ORM\Tools\AttachEntityListenersListener();
    }

    /**
     * Gets the 'doctrine.orm.gspmanager_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_GspmanagerManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.gspmanager_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }

    /**
     * Gets the 'doctrine.orm.tontine_entity_listener_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerAwareEntityListenerResolver A Doctrine\Bundle\DoctrineBundle\Mapping\ContainerAwareEntityListenerResolver instance
     */
    protected function getDoctrine_Orm_TontineEntityListenerResolverService()
    {
        $this->services['doctrine.orm.tontine_entity_listener_resolver'] = $instance = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerAwareEntityListenerResolver($this);

        $instance->register(new \tontineBundle\EntityListener\TontineEntityListener($this->get('security.token_storage')));

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.tontine_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Doctrine\ORM\EntityManager A Doctrine\ORM\EntityManager instance
     */
    protected function getDoctrine_Orm_TontineEntityManagerService($lazyLoad = true)
    {
        $a = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/tontineBundle/Entity'))), 'tontineBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('tontineBundle' => 'tontineBundle\\Entity'));
        $b->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.tontine_metadata_cache'));
        $b->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.tontine_query_cache'));
        $b->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.tontine_result_cache'));
        $b->setMetadataDriverImpl($a);
        $b->setProxyDir((__DIR__.'/doctrine/orm/Proxies'));
        $b->setProxyNamespace('Proxies');
        $b->setAutoGenerateProxyClasses(true);
        $b->setClassMetadataFactoryName('Doctrine\\ORM\\Mapping\\ClassMetadataFactory');
        $b->setDefaultRepositoryClassName('EldoMagan\\Doctrine\\ORM\\BaseRepository');
        $b->setNamingStrategy($this->get('doctrine.orm.naming_strategy.underscore'));
        $b->setQuoteStrategy($this->get('doctrine.orm.quote_strategy.default'));
        $b->setEntityListenerResolver($this->get('doctrine.orm.tontine_entity_listener_resolver'));

        $this->services['doctrine.orm.tontine_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.tontine_connection'), $b);

        $this->get('doctrine.orm.tontine_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.tontine_entity_manager.property_info_extractor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bridge\Doctrine\PropertyInfo\DoctrineExtractor A Symfony\Bridge\Doctrine\PropertyInfo\DoctrineExtractor instance
     */
    protected function getDoctrine_Orm_TontineEntityManager_PropertyInfoExtractorService()
    {
        return $this->services['doctrine.orm.tontine_entity_manager.property_info_extractor'] = new \Symfony\Bridge\Doctrine\PropertyInfo\DoctrineExtractor($this->get('doctrine.orm.tontine_entity_manager')->getMetadataFactory());
    }

    /**
     * Gets the 'doctrine.orm.tontine_listeners.attach_entity_listeners' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\Tools\AttachEntityListenersListener A Doctrine\ORM\Tools\AttachEntityListenersListener instance
     */
    protected function getDoctrine_Orm_TontineListeners_AttachEntityListenersService()
    {
        return $this->services['doctrine.orm.tontine_listeners.attach_entity_listeners'] = new \Doctrine\ORM\Tools\AttachEntityListenersListener();
    }

    /**
     * Gets the 'doctrine.orm.tontine_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator A Doctrine\Bundle\DoctrineBundle\ManagerConfigurator instance
     */
    protected function getDoctrine_Orm_TontineManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.tontine_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.gspmanager_metadata_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_GspmanagerMetadataCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.gspmanager_metadata_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();

        $instance->setNamespace('sf2orm_gspmanager_c27fe04c4b7fe4b7b1bfee499fd4b8c9bfddca814fb9e2970f8332deb2d4e456');

        return $instance;
    }

    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.gspmanager_query_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_GspmanagerQueryCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.gspmanager_query_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.gspmanager_result_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_GspmanagerResultCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.gspmanager_result_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.tontine_metadata_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_TontineMetadataCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.tontine_metadata_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();

        $instance->setNamespace('sf2orm_tontine_c27fe04c4b7fe4b7b1bfee499fd4b8c9bfddca814fb9e2970f8332deb2d4e456');

        return $instance;
    }

    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.tontine_query_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_TontineQueryCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.tontine_query_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.tontine_result_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_TontineResultCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.tontine_result_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'dompdf' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core23\DompdfBundle\Wrapper\DompdfWrapper A Core23\DompdfBundle\Wrapper\DompdfWrapper instance
     */
    protected function getDompdfService()
    {
        return $this->services['dompdf'] = new \Core23\DompdfBundle\Wrapper\DompdfWrapper(($this->targetDirs[3].'/app/../web'), array('dpi' => 150, 'defaultPaperSize' => 'A4', 'defaultPaperOrientation' => 'landscape'));
    }
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('tontineBundle\\Form\\AgentType' => 'agent.form.registration', 'tontineBundle\\Form\\Type\\AgentGroupType' => 'tontine.form.agent_group', 'tontineBundle\\Form\\Type\\AwesomeSelectorType' => 'tontine.type.awesome_selector', 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => 'form.type.form', 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType' => 'form.type.choice', 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType' => 'form.type.entity', 'FOS\\UserBundle\\Form\\Type\\UsernameFormType' => 'fos_user.username_form_type', 'FOS\\UserBundle\\Form\\Type\\ProfileFormType' => 'fos_user.profile.form.type', 'FOS\\UserBundle\\Form\\Type\\RegistrationFormType' => 'fos_user.registration.form.type', 'FOS\\UserBundle\\Form\\Type\\ChangePasswordFormType' => 'fos_user.change_password.form.type', 'FOS\\UserBundle\\Form\\Type\\ResettingFormType' => 'fos_user.resetting.form.type', 'FOS\\UserBundle\\Form\\Type\\GroupFormType' => 'fos_user.group.form.type', 'Misd\\PhoneNumberBundle\\Form\\Type\\PhoneNumberType' => 'misd_phone_number.form.type'), array('Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.form.validator', 2 => 'form.type_extension.upload.validator', 3 => 'form.type_extension.csrf', 4 => 'form.type_extension.form.data_collector', 5 => 'fos_rest.form.extension.csrf_disable'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\RepeatedType' => array(0 => 'form.type_extension.repeated.validator'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType' => array(0 => 'form.type_extension.submit.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine'))), $this->get('form.resolved_type_factory'));
    }
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/(api|oauth)', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json'), 'fallback_format' => 'json', 'methods' => NULL, 'attributes' => array(), 'stop' => false, 'prefer_extension' => '2.0'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('tontineBundle\\Entity\\Agent');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('tontineBundle\\Entity\\Agent');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'tontineBundle\\Form\\AgentType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('tontineBundle\\Entity\\Agent');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('tontineBundle\\Entity\\Agent');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('fos_user.object_manager'), 'tontineBundle\\Entity\\Agent');
    }
    ...
    /**
     * Gets the 'guzzle.client.api_gspmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzle_Client_ApiGspmanagerService()
    {
        $a = \GuzzleHttp\HandlerStack::create();
        $a->push($this->get("guzzle_bundle.middleware.wsse.api_gspmanager")->attach());
        $a->push($this->get("guzzle_bundle.middleware.request_header.api_gspmanager")->attach());
        $a->push($this->get("guzzle_bundle.middleware.log.api_gspmanager")->log());
        $a->unshift($this->get("guzzle_bundle.middleware.event_dispatch.api_gspmanager")->dispatchEvent());

        return $this->services['guzzle.client.api_gspmanager'] = new \GuzzleHttp\Client(array('base_uri' => 'http://localhost/manager/web/tontine/', 'handler' => $a, 'auth' => array(0 => 'fa', 1 => 'fa'), 'timeout' => 300000000));
    }
    ...
    /**
     * Gets the 'guzzle_bundle.middleware.event_dispatch.api_gspmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_EventDispatch_ApiGspmanagerService()
    {
        return $this->services['guzzle_bundle.middleware.event_dispatch.api_gspmanager'] = new \EightPoints\Bundle\GuzzleBundle\Middleware\EventDispatchMiddleware($this->get('debug.event_dispatcher'), 'api_gspmanager');
    }

    /**
     * Gets the 'guzzle_bundle.middleware.log.api_gspmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_Log_ApiGspmanagerService()
    {
        return $this->services['guzzle_bundle.middleware.log.api_gspmanager'] = new \EightPoints\Bundle\GuzzleBundle\Middleware\LogMiddleware($this->get('guzzle_bundle.logger'), $this->get('guzzle_bundle.formatter'));
    }

    /**
     * Gets the 'guzzle_bundle.middleware.request_header.api_gspmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_RequestHeader_ApiGspmanagerService()
    {
        return $this->services['guzzle_bundle.middleware.request_header.api_gspmanager'] = new \EightPoints\Bundle\GuzzleBundle\Middleware\RequestHeaderMiddleware(array('Accept' => 'application/json'));
    }

    /**
     * Gets the 'guzzle_bundle.middleware.wsse.api_gspmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_Wsse_ApiGspmanagerService()
    {
        return $this->services['guzzle_bundle.middleware.wsse.api_gspmanager'] = new \EightPoints\Guzzle\WsseAuthMiddleware('fa', 'fa');
    }
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('d-m-Y\\TH:i:sP', 'UTC', true);
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'tontineBundle' => ($this->targetDirs[3].'/src/tontineBundle/Resources/config/serializer'), 'FOS\\JsRoutingBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/jsrouting-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Misd\\PhoneNumberBundle' => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'tontineApiBundle' => ($this->targetDirs[3].'/src/tontineApiBundle/Resources/config/serializer'), 'GSPBundle' => ($this->targetDirs[3].'/src/GSPBundle/Resources/config/serializer'), 'EightPoints\\Bundle\\GuzzleBundle' => ($this->targetDirs[3].'/vendor/eightpoints/guzzle-bundle/EightPoints/Bundle/GuzzleBundle/Resources/config/serializer'), 'Core23\\DompdfBundle' => ($this->targetDirs[3].'/vendor/core23/dompdf-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer')));
    ...
    protected function getProfilerService()
    {
        ...
        $c->addLogger('tontine', $this->get('doctrine.dbal.logger.profiling.tontine'));
        $c->addLogger('gspmanager', $this->get('doctrine.dbal.logger.profiling.gspmanager'));
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestRouteLoader($this, $b, $a, new \FOS\RestBundle\Routing\Loader\Reader\RestControllerReader(new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($c, $this->get('fos_rest.request.param_fetcher.reader'), $this->get('fos_rest.inflector'), false, array('xml' => false, 'json' => false, 'html' => true)), $c), NULL));
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($b, $e, false, array('xml' => false, 'json' => false, 'html' => true), NULL));
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($b, $e, false, array('xml' => false, 'json' => false, 'html' => true), NULL));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('tontineBundle\\Entity\\Agent' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.api_authentication' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/authenticate'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\SimplePreAuthenticationListener($a, $b, 'api', $this->get('auth_token_authenticator'), $c, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '589b127ab609e2.16451110', $c, $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'api', NULL, NULL, NULL, $c, true));
    }

    /**
     * Gets the 'security.firewall.map.context.api_authentication' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_ApiAuthenticationService()
    {
        return $this->services['security.firewall.map.context.api_authentication'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $i->setOptions(array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email'), 1 => $this->get('user_auth_token_provider')), 'main', $b, $c, $d), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $this->get('security.authentication.session_strategy'), $e, 'main', $i, $j, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '589b127ab609e2.16451110', $b, $g), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'fos_user_security_login', false), NULL, NULL, $b, false));
    }
    ...
    /**
     * Gets the 'tontine.form.agent_group' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tontineBundle\Form\Type\AgentGroupType A tontineBundle\Form\Type\AgentGroupType instance
     */
    protected function getTontine_Form_AgentGroupService()
    {
        return $this->services['tontine.form.agent_group'] = new \tontineBundle\Form\Type\AgentGroupType($this->get('tontine.manager.group'));
    }

    /**
     * Gets the 'tontine.gsp.entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tontineBundle\Manager\GspEntityManager A tontineBundle\Manager\GspEntityManager instance
     */
    protected function getTontine_Gsp_EntityManagerService()
    {
        return $this->services['tontine.gsp.entity_manager'] = new \tontineBundle\Manager\GspEntityManager($this->get('doctrine.dbal.gspmanager_connection'));
    }

    /**
     * Gets the 'tontine.journal' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tontineBundle\EventListener\JournalListener A tontineBundle\EventListener\JournalListener instance
     */
    protected function getTontine_JournalService()
    {
        return $this->services['tontine.journal'] = new \tontineBundle\EventListener\JournalListener($this->get('security.token_storage'), $this);
    }

    /**
     * Gets the 'tontine.manager.bien' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tontineBundle\Manager\BienManager A tontineBundle\Manager\BienManager instance
     */
    protected function getTontine_Manager_BienService()
    {
        return $this->services['tontine.manager.bien'] = new \tontineBundle\Manager\BienManager($this->get('doctrine.dbal.gspmanager_connection'));
    }

    /**
     * Gets the 'tontine.manager.dashboard' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tontineBundle\Manager\DashboardManager A tontineBundle\Manager\DashboardManager instance
     */
    protected function getTontine_Manager_DashboardService()
    {
        return $this->services['tontine.manager.dashboard'] = new \tontineBundle\Manager\DashboardManager($this->get('doctrine.orm.tontine_entity_manager'), $this->get('security.authorization_checker'), $this->get('security.token_storage'));
    }

    /**
     * Gets the 'tontine.manager.group' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tontineBundle\Manager\AgentGroupManager A tontineBundle\Manager\AgentGroupManager instance
     */
    protected function getTontine_Manager_GroupService()
    {
        return $this->services['tontine.manager.group'] = new \tontineBundle\Manager\AgentGroupManager(array(0 => array('label' => 'Opérations sur les clients', 'roles' => array('ROLE_CLIENT_VIEW' => 'Voir la liste des clients', 'ROLE_CLIENT_CREATE' => 'Enregistrer un nouveau client', 'ROLE_CLIENT_EDIT' => 'Modifier les informations d\'un client', 'ROLE_CLIENT_ADD_CG' => 'Faire signer les condition générales au client', 'ROLE_CLIENT_DELETE' => 'Supprimer un client', 'ROLE_CLIENT_UPDATE_CG' => 'Mettre à jour  les conditions générales', 'ROLE_CLIENT_VISITE_VIEW' => 'Voir la liste des vistes du client')), 1 => array('label' => 'Opérations sur les agents', 'roles' => array('ROLE_AGENT_VIEW' => 'Voir la liste des agents', 'ROLE_AGENT_CREATE' => 'Enregistrer un nouvel agent', 'ROLE_AGENT_EDIT' => 'Modifier les informations d\'un agent', 'ROLE_AGENT_ENABLE' => 'Activer un agent', 'ROLE_AGENT_DISABLE' => 'Désactiver un agent')), 2 => array('label' => 'Opérations sur les agences d\'APHEDD Finance', 'roles' => array('ROLE_AGENCY_VIEW' => 'Voir la liste des agences', 'ROLE_AGENCY_CREATE' => 'Ajouter une nouvelle agence', 'ROLE_AGENCY_EDIT' => 'Modifier les informations d\'une agence')), 3 => array('label' => 'Opérations sur les tontines', 'roles' => array('ROLE_TONTINE_VIEW' => 'Voir la liste des tontines', 'ROLE_TONTINE_CREATE' => 'Créer une nouvelle tontine', 'ROLE_TONTINE_EDIT' => 'Modifier les informations d\'une tontine', 'ROLE_TONTINE_ADD_MISE' => 'Déposer une mise sur une tontine', 'ROLE_TONTINE_VALIDATE_MISE' => 'Encaisser les mises (Validation)', 'ROLE_TONTINE_CONTRAT' => 'Etablir le contrat d\'une tontine', 'ROLE_TONTINE_FINALIZE' => 'Cloturer une tontine', 'ROLE_TONTINE_CANCEL' => 'Résilier une tontine')), 4 => array('label' => 'Opérations sur les biens', 'roles' => array('ROLE_BIEN_SEARCH' => 'Faire une recherche de biens', 'ROLE_BIEN_CREATE_OPTIONS' => 'Établir la feuille de choix', 'ROLE_BIEN_VIEW_OPTIONS' => 'Voir la feuille de choix', 'ROLE_BIEN_PRINT_OPTIONS' => 'Télécharger la feuille de choix', 'ROLE_BIEN_VISITE' => 'Enregistrer  la date de visite du bien')), 5 => array('label' => 'Opérations sur les transferts de fonds', 'roles' => array('ROLE_TRANSFER_VIEW' => 'Voir la liste des transferts de fonds', 'ROLE_TRANSFER_CREATE' => 'Faire un transfert de fonds')), 6 => array('label' => 'Paramètres de l\'application', 'roles' => array('ROLE_SETTING_EDIT' => 'Modifier les paramètres', 'ROLE_GROUP_VIEW' => 'Voir la liste des profils d\'agent', 'ROLE_GROUP_CREATE' => 'Créer un profil d\'agent', 'ROLE_GROUP_EDIT' => 'Modifier les droits d\'un profil', 'ROLE_GROUP_DELETE' => 'Modifier un profil d\'agent')), 7 => array('label' => 'Les états', 'roles' => array('ROLE_ETAT_VIEW' => 'Consulter les états selon des critères', 'ROLE_ETAT_BIEN_VIEW' => 'Consulter les états des biens selon des critères'))), array(0 => 'ROLE_CLIENT_VIEW', 1 => 'ROLE_CLIENT_CREATE', 2 => 'ROLE_TONTINE_VIEW', 3 => 'ROLE_TONTINE_CREATE', 4 => 'ROLE_BIEN_SEARCH', 5 => 'ROLE_BIEN_VIEW_OPTIONS'));
    }

    /**
     * Gets the 'tontine.menu_counters' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tontineBundle\Counters\MenuCounters A tontineBundle\Counters\MenuCounters instance
     */
    protected function getTontine_MenuCountersService()
    {
        return $this->services['tontine.menu_counters'] = new \tontineBundle\Counters\MenuCounters($this->get('doctrine.orm.tontine_entity_manager'), $this);
    }

    /**
     * Gets the 'tontine.type.awesome_selector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tontineBundle\Form\Type\AwesomeSelectorType A tontineBundle\Form\Type\AwesomeSelectorType instance
     */
    protected function getTontine_Type_AwesomeSelectorService()
    {
        return $this->services['tontine.type.awesome_selector'] = new \tontineBundle\Form\Type\AwesomeSelectorType($this->get('doctrine.orm.tontine_entity_manager'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.es.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml'), 4 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.fi.xlf')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.de.xlf')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.ru.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.nl.xlf')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.sr_Latn.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.hr.xlf')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.af.yml')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/src/tontineBundle/Resources/translations/FOSUserBundle.fr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml'), 6 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.fr.xlf')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.it.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.pl.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml')), 'ky' => array(0 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ky.yml'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ky.yml')), 'dk' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.dk.xlf')), 'en_PH' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_PH.xlf')), 'se' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.se.xlf')), 'en_SG' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_SG.xlf')), 'en_AU' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_AU.xlf')), 'en_NZ' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_NZ.xlf')), 'bs_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.bs_Cyrl.xlf')), 'en_CA' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_CA.xlf')), 'es_419' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.es_419.xlf')), 'en_GB' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_GB.xlf')), 'en_ZA' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_ZA.xlf')), 'en_US' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_US.xlf')), 'bs' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.bs.xlf')), 'sr' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.sr.xlf')), 'en_IE' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_IE.xlf')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'MisdPhoneNumberBundle:Form:tel.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'AppBundle', 8 => 'tontineBundle', 9 => 'FOSJsRoutingBundle', 10 => 'FOSUserBundle', 11 => 'AsseticBundle', 12 => 'MisdPhoneNumberBundle', 13 => 'FOSRestBundle', 14 => 'JMSSerializerBundle', 15 => 'tontineApiBundle', 16 => 'GSPBundle', 17 => 'GuzzleBundle', 18 => 'Core23DompdfBundle', 19 => 'DebugBundle', 20 => 'WebProfilerBundle', 21 => 'SensioDistributionBundle', 22 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addGlobal('menuCounters', $this->get('tontine.menu_counters'));
        $instance->addGlobal('api_server_name', 'http://localhost');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/tontineBundle/Resources/views'), 'tontine');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/tontineApiBundle/Resources/views'), 'tontineApi');
        $instance->addPath(($this->targetDirs[3].'/src/GSPBundle/Resources/views'), 'GSP');
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \tontineApiBundle\Security\UserAuthTokenAuthenticator A tontineApiBundle\Security\UserAuthTokenAuthenticator instance
     */
    protected function getAuthTokenAuthenticatorService()
    {
        return $this->services['auth_token_authenticator'] = new \tontineApiBundle\Security\UserAuthTokenAuthenticator($this->get('security.http_utils'));
    }
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.gspmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_Logger_Profiling_GspmanagerService()
    {
        return $this->services['doctrine.dbal.logger.profiling.gspmanager'] = new \Doctrine\DBAL\Logging\DebugStack();
    }

    /**
     * Gets the 'doctrine.dbal.logger.profiling.tontine' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance
     */
    protected function getDoctrine_Dbal_Logger_Profiling_TontineService()
    {
        return $this->services['doctrine.dbal.logger.profiling.tontine'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/'), array(0 => 'ROLE_GSP_TONTINE_SUPER_ADMIN', 1 => 'ROLE_GSP_TONTINE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/myprofile'), array(0 => 'ROLE_USER'), NULL);
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\SimpleAuthenticationProvider($this->get('auth_token_authenticator'), $this->get('user_auth_token_provider'), 'api'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('589b127ab609e2.16451110'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username_email'), $this->get('security.user_checker.api'), 'main', $this->get('security.encoder_factory'), true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('589b127ab609e2.16451110')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_GSP_TONTINE_CAISSIERE' => array(0 => 'ROLE_USER', 1 => 'ROLE_CAISSIERE'), 'ROLE_GSP_TONTINE_AGENT_DE_TRANSFERT' => array(0 => 'ROLE_USER', 1 => 'ROLE_AGENT_TRANSFERT'), 'ROLE_GSP_TONTINE_COLLECTEUR' => array(0 => 'ROLE_USER', 1 => 'ROLE_COLLECTEUR'), 'ROLE_GSP_TONTINE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_GSP_TONTINE_COLLECTEUR', 3 => 'ROLE_GSP_TONTINE_CAISSIERE'), 'ROLE_GSP_TONTINE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_GSP_TONTINE_ADMIN', 2 => 'ROLE_CAISSIERE', 3 => 'ROLE_AGENT_TRANSFERT', 4 => 'ROLE_COLLECTEUR', 5 => 'ROLE_ADMIN')));
    }
    ...
    /**
     * Gets the 'user_auth_token_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \tontineApiBundle\Security\UserAuthTokenProvider A tontineApiBundle\Security\UserAuthTokenProvider instance
     */
    protected function getUserAuthTokenProviderService()
    {
        return $this->services['user_auth_token_provider'] = new \tontineApiBundle\Security\UserAuthTokenProvider($this->get('doctrine.orm.tontine_entity_manager'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'tontineBundle' => 'tontineBundle\\tontineBundle',
                ...
                'tontineApiBundle' => 'tontineApiBundle\\tontineApiBundle',
                'GSPBundle' => 'GSPBundle\\GSPBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'tontineBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/tontineBundle'),
                ...
                'tontineApiBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/tontineApiBundle'),
                    'namespace' => 'tontineApiBundle',
                ),
                'GSPBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSPBundle'),
                    'namespace' => 'GSPBundle',
                ),
                'GuzzleBundle' => array(
                    'parent' => NULL,
                ...
                'Core23DompdfBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/core23/dompdf-bundle'),
            ...
            'database_user' => 'root',
            'database_password' => 'mysqlconnect',
            'gspmanager_database_host' => '127.0.0.1',
            'gspmanager_database_port' => NULL,
            'gspmanager_database_name' => 'manager',
            'gspmanager_database_user' => 'root',
            'gspmanager_database_password' => 'mysqlconnect',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'pieces_path' => ($this->targetDirs[3].'/app/../web/uploads/pieces'),
            'api_server_name' => 'http://localhost',
            'api_gspmanager_endpoint' => 'http://localhost/manager/web/tontine/',
            'default_roles' => array(
                0 => 'ROLE_CLIENT_VIEW',
                1 => 'ROLE_CLIENT_CREATE',
                2 => 'ROLE_TONTINE_VIEW',
                3 => 'ROLE_TONTINE_CREATE',
                4 => 'ROLE_BIEN_SEARCH',
                5 => 'ROLE_BIEN_VIEW_OPTIONS',
            ),
            'roles_sections' => array(
                0 => array(
                    'label' => 'Opérations sur les clients',
                    'roles' => array(
                        'ROLE_CLIENT_VIEW' => 'Voir la liste des clients',
                        'ROLE_CLIENT_CREATE' => 'Enregistrer un nouveau client',
                        'ROLE_CLIENT_EDIT' => 'Modifier les informations d\'un client',
                        'ROLE_CLIENT_ADD_CG' => 'Faire signer les condition générales au client',
                        'ROLE_CLIENT_DELETE' => 'Supprimer un client',
                        'ROLE_CLIENT_UPDATE_CG' => 'Mettre à jour  les conditions générales',
                        'ROLE_CLIENT_VISITE_VIEW' => 'Voir la liste des vistes du client',
                    ),
                ),
                1 => array(
                    'label' => 'Opérations sur les agents',
                    'roles' => array(
                        'ROLE_AGENT_VIEW' => 'Voir la liste des agents',
                        'ROLE_AGENT_CREATE' => 'Enregistrer un nouvel agent',
                        'ROLE_AGENT_EDIT' => 'Modifier les informations d\'un agent',
                        'ROLE_AGENT_ENABLE' => 'Activer un agent',
                        'ROLE_AGENT_DISABLE' => 'Désactiver un agent',
                    ),
                ),
                2 => array(
                    'label' => 'Opérations sur les agences d\'APHEDD Finance',
                    'roles' => array(
                        'ROLE_AGENCY_VIEW' => 'Voir la liste des agences',
                        'ROLE_AGENCY_CREATE' => 'Ajouter une nouvelle agence',
                        'ROLE_AGENCY_EDIT' => 'Modifier les informations d\'une agence',
                    ),
                ),
                3 => array(
                    'label' => 'Opérations sur les tontines',
                    'roles' => array(
                        'ROLE_TONTINE_VIEW' => 'Voir la liste des tontines',
                        'ROLE_TONTINE_CREATE' => 'Créer une nouvelle tontine',
                        'ROLE_TONTINE_EDIT' => 'Modifier les informations d\'une tontine',
                        'ROLE_TONTINE_ADD_MISE' => 'Déposer une mise sur une tontine',
                        'ROLE_TONTINE_VALIDATE_MISE' => 'Encaisser les mises (Validation)',
                        'ROLE_TONTINE_CONTRAT' => 'Etablir le contrat d\'une tontine',
                        'ROLE_TONTINE_FINALIZE' => 'Cloturer une tontine',
                        'ROLE_TONTINE_CANCEL' => 'Résilier une tontine',
                    ),
                ),
                4 => array(
                    'label' => 'Opérations sur les biens',
                    'roles' => array(
                        'ROLE_BIEN_SEARCH' => 'Faire une recherche de biens',
                        'ROLE_BIEN_CREATE_OPTIONS' => 'Établir la feuille de choix',
                        'ROLE_BIEN_VIEW_OPTIONS' => 'Voir la feuille de choix',
                        'ROLE_BIEN_PRINT_OPTIONS' => 'Télécharger la feuille de choix',
                        'ROLE_BIEN_VISITE' => 'Enregistrer  la date de visite du bien',
                    ),
                ),
                5 => array(
                    'label' => 'Opérations sur les transferts de fonds',
                    'roles' => array(
                        'ROLE_TRANSFER_VIEW' => 'Voir la liste des transferts de fonds',
                        'ROLE_TRANSFER_CREATE' => 'Faire un transfert de fonds',
                    ),
                ),
                6 => array(
                    'label' => 'Paramètres de l\'application',
                    'roles' => array(
                        'ROLE_SETTING_EDIT' => 'Modifier les paramètres',
                        'ROLE_GROUP_VIEW' => 'Voir la liste des profils d\'agent',
                        'ROLE_GROUP_CREATE' => 'Créer un profil d\'agent',
                        'ROLE_GROUP_EDIT' => 'Modifier les droits d\'un profil',
                        'ROLE_GROUP_DELETE' => 'Modifier un profil d\'agent',
                    ),
                ),
                7 => array(
                    'label' => 'Les états',
                    'roles' => array(
                        'ROLE_ETAT_VIEW' => 'Consulter les états selon des critères',
                        'ROLE_ETAT_BIEN_VIEW' => 'Consulter les états des biens selon des critères',
                    ),
                ),
            ),
            'locale' => 'fr',
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_GSP_TONTINE_CAISSIERE' => array(
                    0 => 'ROLE_USER',
                    1 => 'ROLE_CAISSIERE',
                ),
                'ROLE_GSP_TONTINE_AGENT_DE_TRANSFERT' => array(
                    0 => 'ROLE_USER',
                    1 => 'ROLE_AGENT_TRANSFERT',
                ),
                'ROLE_GSP_TONTINE_COLLECTEUR' => array(
                    0 => 'ROLE_USER',
                    1 => 'ROLE_COLLECTEUR',
                ),
                'ROLE_GSP_TONTINE_ADMIN' => array(
                    0 => 'ROLE_USER',
                    1 => 'ROLE_ADMIN',
                    2 => 'ROLE_GSP_TONTINE_COLLECTEUR',
                    3 => 'ROLE_GSP_TONTINE_CAISSIERE',
                ),
                'ROLE_GSP_TONTINE_SUPER_ADMIN' => array(
                    0 => 'ROLE_USER',
                    1 => 'ROLE_GSP_TONTINE_ADMIN',
                    2 => 'ROLE_CAISSIERE',
                    3 => 'ROLE_AGENT_TRANSFERT',
                    4 => 'ROLE_COLLECTEUR',
                    5 => 'ROLE_ADMIN',
                ),
            ),
            ...
            'doctrine.entity_managers' => array(
                'tontine' => 'doctrine.orm.tontine_entity_manager',
                'gspmanager' => 'doctrine.orm.gspmanager_entity_manager',
            ),
            'doctrine.default_entity_manager' => 'tontine',
            ...
            'doctrine.connections' => array(
                'tontine' => 'doctrine.dbal.tontine_connection',
                'gspmanager' => 'doctrine.dbal.gspmanager_connection',
            ),
            'doctrine.default_connection' => 'tontine',
            ...
            'fos_user.model.user.class' => 'tontineBundle\\Entity\\Agent',
            ...
            'fos_user.registration.form.type' => 'tontineBundle\\Form\\AgentType',
            ...
            'core23.dompdf.wrapper.class' => 'Core23\\DompdfBundle\\Wrapper\\DompdfWrapper',
            'core23.dompdf_web' => ($this->targetDirs[3].'/app/../web'),
            'core23.dompdf_options' => array(
                'dpi' => 150,
                'defaultPaperSize' => 'A4',
