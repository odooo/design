...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('InJC1xGFxj', 0, 'cN6hnN2InnJDSvDicdzDIB', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vm0jATTIfw', 0, 'cN6hnN2InnJDSvDicdzDIB', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OK9If19S9S', 0, 'cN6hnN2InnJDSvDicdzDIB', (__DIR__.'/pools'), $a));
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\SimplePreAuthenticationListener($a, $b, 'api', $this->get('auth_token_authenticator'), $c, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '58a07c8d12e8a1.08782119', $c, $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'api', NULL, NULL, NULL, $c, true));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email'), 1 => $this->get('user_auth_token_provider')), 'main', $b, $c, $d), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $this->get('security.authentication.session_strategy'), $e, 'main', $i, $j, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '58a07c8d12e8a1.08782119', $b, $g), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'fos_user_security_login', false), NULL, NULL, $b, false));
    }
    ...
    {
        return $this->services['tontine.manager.group'] = new \tontineBundle\Manager\AgentGroupManager(array(0 => array('label' => 'Opérations sur les clients', 'roles' => array('ROLE_CLIENT_VIEW' => 'Voir la liste des clients', 'ROLE_CLIENT_CREATE' => 'Enregistrer un nouveau client', 'ROLE_CLIENT_EDIT' => 'Modifier les informations d\'un client', 'ROLE_CLIENT_DELETE' => 'Supprimer un client')), 1 => array('label' => 'Opérations sur les agents', 'roles' => array('ROLE_AGENT_VIEW' => 'Voir la liste des agents', 'ROLE_AGENT_CREATE' => 'Enregistrer un nouvel agent', 'ROLE_AGENT_EDIT' => 'Modifier les informations d\'un agent', 'ROLE_AGENT_ENABLE' => 'Activer un agent', 'ROLE_AGENT_DISABLE' => 'Désactiver un agent')), 2 => array('label' => 'Opérations sur les agences de Global Design', 'roles' => array('ROLE_AGENCY_VIEW' => 'Voir la liste des agences', 'ROLE_AGENCY_CREATE' => 'Ajouter une nouvelle agence', 'ROLE_AGENCY_EDIT' => 'Modifier les informations d\'une agence', 'ROLE_AGENCY_DELETE' => 'Supprimer une agence')), 3 => array('label' => 'Opérations sur les commandes des clients', 'roles' => array('ROLE_COMMANDE_VIEW' => 'Voir la liste des commandes', 'ROLE_COMMANDE_CREATE' => 'Enregistrer une nouvelle commande', 'ROLE_COMMANDE_EDIT' => 'Modifier les informations d\'une commande', 'ROLE_BENEFICE_VIEW' => 'Voir les bénéfices', 'ROLE_COMMANDE_DELETE' => 'Supprimer une commande')), 4 => array('label' => 'Paramètres de l\'application', 'roles' => array('ROLE_SETTING_EDIT' => 'Modifier les paramètres', 'ROLE_GROUP_VIEW' => 'Voir la liste des profils d\'agent', 'ROLE_GROUP_CREATE' => 'Créer un profil d\'agent', 'ROLE_GROUP_EDIT' => 'Modifier les droits d\'un profil', 'ROLE_GROUP_DELETE' => 'Modifier un profil d\'agent'))), array(0 => 'ROLE_CLIENT_VIEW', 1 => 'ROLE_AGENT_VIEW', 2 => 'ROLE_CLIENT_CREATE', 3 => 'ROLE_PAGNE_VIEW'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'roles_sections' => array(
                ...
                2 => array(
                    'label' => 'Opérations sur les agences de Global Design',
                    'roles' => array(
                        ...
                        'ROLE_AGENCY_DELETE' => 'Supprimer une agence',
                    ),
                ),
                3 => array(
                    'label' => 'Opérations sur les commandes des clients',
                    'roles' => array(
                        'ROLE_COMMANDE_VIEW' => 'Voir la liste des commandes',
                        'ROLE_COMMANDE_CREATE' => 'Enregistrer une nouvelle commande',
                        'ROLE_COMMANDE_EDIT' => 'Modifier les informations d\'une commande',
                        'ROLE_BENEFICE_VIEW' => 'Voir les bénéfices',
                        'ROLE_COMMANDE_DELETE' => 'Supprimer une commande',
                    ),
                ),
                4 => array(
